...
INSERT INTO Trip VALUES('055001', '055', 'EIU112', '2016-05-15', 62,100,80);
INSERT INTO Trip VALUES('055002', '055', 'EIU112', '2016-06-23', 62,200,150);
INSERT INTO Trip VALUES('021001', '021', 'JDO682', '2016-12-04', 3, 400,250);
INSERT INTO Trip VALUES('047001', '047', 'TPO652', '2016-10-20', 51, 120,80);
...
Hotel_Booking_No	CHAR(12)	NOT NULL,
...
Phone			VARCHAR(10),
Auth      VARCHAR(32),
Enabled   TINYINT NOT NULL CHECK (Enabled >= 0 and Enabled <=1),

CONSTRAINT Customer_pk PRIMARY KEY (Customer_Id)
);

INSERT INTO Customer VALUES(001, 'Freddie', NULL, 'Khan', '500', 'Waverly Road', 'Chadstone', '3555', 'fred.khan@holmesglen.edu.au', NULL,'b5ae141b1493dc513e0758811c983d66');
INSERT INTO Customer VALUES(002, 'William', 'B', 'Pitt', '200', 'St. Kilda Road', 'St. Kilda', '3147', 'bill.pitt@gmail.com','0351806451','481f0a5bd7d36c5ceefb647f128f0d7e');
INSERT INTO Customer VALUES(003, 'James',NULL,'Mangold','646','fw street','Melbourne','3000','James.mang@gmail.com',NULL,'c8db0556f8994dd794d57d58519c6b98');


CREATE TABLE Booking
(
Booking_No	INTEGER NOT NULL AUTO_INCREMENT,
...
INSERT INTO Booking VALUES(101, 1,'055001','2016-08-15',2,2,100);
INSERT INTO Booking VALUES(102, 2,'055001','2016-05-27',1,0,500);
INSERT INTO Booking VALUES(103, 1,'047001','2016-11-01',2,0,150);
...
INSERT INTO Customer_Review VALUES('055001', 1, 5, 'Excellent trip, I will be booking with you guys again next year!', 'The whole trip was very reasonably priced.', 'None!');
INSERT INTO Customer_Review VALUES('021001', 2, 3, 'It was okay, not as good as Kontiki', 'Staff were nice', 'The food was rubbish');
INSERT INTO Customer_Review VALUES('047001', 2, 4, 'Better than the last one', 'Staff were nice like last time and the food was better', 'The tour bus was too noisy');
